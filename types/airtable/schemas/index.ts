...
export const updateJobSchema = z
  .object({
    ...
    non_oem_consent_at: z.string().datetime().optional(),
    quote_timeout_qstash_id: z.string().optional(),
    original_parts_cost: z.number().nonnegative().optional(),
    ...
    receipt_total: z.number().nonnegative().optional(),
    ...
    quote_pending_admin_at: z.string().datetime().optional(),
    quote_submitted_at: z.string().datetime().optional(),
    quote_approved_at: z.string().datetime().optional(),
    awaiting_parts_consent_at: z.string().datetime().optional(),
    quote_declined_at: z.string().datetime().optional(),
    requote_submitted_at: z.string().datetime().optional(),
    requote_approved_at: z.string().datetime().optional(),
    requote_declined_at: z.string().datetime().optional(),
