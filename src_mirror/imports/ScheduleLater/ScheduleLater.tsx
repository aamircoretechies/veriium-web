        ...
        {isSubmitted ? (
          <div className="w-full max-w-[800px] flex flex-col items-center justify-center text-center p-8 sm:p-12 min-h-[300px]">
            ...
            <p className="font-['Albert_Sans:Regular',sans-serif] font-semibold text-[14px] sm:text-[15px] text-black">
              You will be notified of your match via text message December 12 at 2:30 PM.
            </p>
          </div>
        ) : (
          <div className="w-full max-w-[800px] bg-[#f7f7f7] rounded-[12px] border border-[#ebebeb] p-8 sm:p-12">
            ...
            <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
              ...
              <div className="mt-2">
                <button
                  type="submit"
                  className="w-full sm:w-[300px] bg-[#ffa270] rounded-[10px] py-3.5 font-['Albert_Sans:Bold',sans-serif] font-bold text-[15px] text-black hover:brightness-110 active:scale-95 transition-all duration-150 shadow-sm cursor-pointer text-center"
                >
                  Schedule Later
                </button>
              </div>
